    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="container mx-auto py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            { icon: QrCode, title: 'QR Code Ready', desc: 'Generate beautiful QR codes for tables, flyers, and more.' },
            { icon: Globe, title: 'Multilingual', desc: 'Auto-translate menus to any language for international guests.' },
            { icon: BarChart3, title: 'Analytics', desc: 'See what\'s popular and when customers browse your menu.' },
          ].map((f, i) => (
      ...
      <section className="container mx-auto py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {[
            { name: 'Free', price: '€0', features: ['1 menu', '1 language', 'Basic QR code', 'Unlimited items'] },
            { name: 'Pro', price: '€9/mo', features: ['Unlimited menus', '10 languages', 'Photos & schedules', 'Analytics', 'All templates'], popular: true },
            { name: 'Lifetime', price: '€149', features: ['All Pro features', 'One-time payment', 'Priority support', 'Future updates'] },
          ].map((plan, i) => (
