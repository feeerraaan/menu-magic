  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="container mx-auto py-20 text-center">
        <h1 className="font-display text-4xl md:text-6xl font-bold mb-6 leading-normal">
          ...
          <span className="text-gradient block mt-2 text-white">en minutos</span>
        </h1>
      ...
      <section className="container mx-auto py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          desc: 'Genera códigos QR bonitos para mesas, flyers y más.'
        }, {
          icon: Globe,
          title: 'Multiidioma',
          desc: 'Traduce tu menú automáticamente a cualquier idioma para clientes internacionales.'
        }, {
          icon: BarChart3,
          title: 'Analíticas',
          desc: 'Ve qué platos son los más populares y cuándo consultan tu menú.'
      ...
      <section className="container mx-auto py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          ...
          name: 'Gratis',
          price: '0€',
          features: ['1 menú', '1 idioma', 'Código QR básico', 'Platos ilimitados']
        }, {
          name: 'Pro',
          price: '9€/mes',
          features: ['Menús ilimitados', '10 idiomas', 'Fotos y horarios', 'Analíticas', 'Todas las plantillas'],
          popular: true
        }, {
          name: 'De por vida',
          price: '149€',
          features: ['Todo lo de Pro', 'Pago único', 'Soporte prioritario', 'Actualizaciones futuras']
