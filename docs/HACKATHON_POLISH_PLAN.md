...
| 2026-08-06 | QR code PDF: single page | `dashboard/QRCode.tsx` | The printable PDF could overflow onto an empty 2nd page depending on the preview size. Print layout now caps the QR (`max-width: 400px`, SVG scales down), tightens `@page` margins and font sizes so it always fits one A4 page. | — |
